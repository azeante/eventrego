...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { event_id: @volunteer.event_id, person_id: @volunteer.person_id, role: @volunteer.role } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { event_id: @volunteer.event_id, person_id: @volunteer.person_id, role: @volunteer.role } }
